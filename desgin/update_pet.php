...
if(isset($_POST['update'])){
   ...
   $rename_image_01 = create_unique_id() . 'project' .$image_01_ext;
   ...
   $rename_image_02 = create_unique_id() . 'project' .$image_02_ext;
   ...
   $rename_image_03 = create_unique_id() . 'project' .$image_03_ext;
   ...
   $rename_image_04 = create_unique_id() . 'project' .$image_04_ext;
   ...
   $rename_image_05 = create_unique_id() . 'project' .$image_05_ext;
...
<section class="property-form">
   ...
   <?php
      ...
      echo '<p class="empty">property not found! <a href="../project/post_property.php" style="margin-top:1.5rem;" class="btn">add new</a></p>';
   }
   ?>
